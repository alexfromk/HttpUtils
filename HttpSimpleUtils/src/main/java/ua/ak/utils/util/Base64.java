...
public class Base64 {
	...
	static private final String sBase64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
	...
	public static byte [] fromString(String str) 
	{
		...
		for (int i = 0; i < (str.length() + 3) / 4; i++) {
			...
			for (int j = 0; j < 4; j++)
				s[j] = (short) sBase64.indexOf(str.charAt(i*4+j));
